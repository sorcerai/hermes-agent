...
DEFAULT_CONFIG = {
    ...
    # max_line_length: per-line cap in read_file's line-numbered view (chars). format: default output format (text, json, toon).
    "tool_output": {"max_bytes": 50000, "max_lines": 2000, "max_line_length": 2000, "format": "text"},
